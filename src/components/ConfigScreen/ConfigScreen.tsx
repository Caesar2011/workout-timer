...
export function ConfigScreen() {
  ...
  function handleNumpadChange(val: number) {
    switch (numpadTarget) {
      case 'activeMin':
        setActiveSecs(val * 60 + (activeSecs % 60));
        break;
      case 'activeSec':
        setActiveSecs(Math.floor(activeSecs / 60) * 60 + val);
        break;
      case 'restMin':
        setRestSecs(val * 60 + (restSecs % 60));
        break;
      case 'restSec':
        setRestSecs(Math.floor(restSecs / 60) * 60 + val);
        break;
      case 'rounds':
        setRounds(val);
        break;
      case 'countdown':
        updateSettings({ countdownSecs: val });
        break;
    }
  }
  ...
  function numpadProps(): { value: number; max: number } {
    switch (numpadTarget) {
      case 'activeMin':
        return { value: Math.floor(activeSecs / 60), max: 99 };
      case 'activeSec':
        return { value: activeSecs % 60, max: 59 };
      case 'restMin':
        return { value: Math.floor(restSecs / 60), max: 99 };
      case 'restSec':
        return { value: restSecs % 60, max: 59 };
      case 'rounds':
        return { value: rounds, max: 99 };
      case 'countdown':
        return { value: settings.countdownSecs, max: 60 };
      default:
        return { value: 0, max: 99 };
    }
  }
      ...
      <div class={styles.left}>
        <div class={`${styles.card} ${styles.cardActive}`}>
          ...
          <div class={styles.timeRow}>
            <button
              ...
              onClick={() => setActiveSecs(Math.max(5, activeSecs - 5))}
            >
              −
            </button>
            ...
            <button
              class={styles.stepBtn}
              onClick={() => setActiveSecs(activeSecs + 5)}
            >
              +
            </button>
          </div>
        ...
        <div class={`${styles.card} ${styles.cardRest}`}>
          ...
          <div class={styles.timeRow}>
            <button
              class={styles.stepBtn}
              onClick={() => setRestSecs(Math.max(0, restSecs - 5))}
            >
              −
            </button>
            ...
            <button
              class={styles.stepBtn}
              onClick={() => setRestSecs(restSecs + 5)}
            >
              +
            </button>
          </div>
      ...
      <div class={styles.right}>
        ...
        <div class={`${styles.card} ${styles.cardRounds}`}>
          ...
          <div class={styles.timeRow}>
            ...
            <button
              class={styles.roundsValue}
              onClick={() => openNumpad('rounds')}
            >
        ...
        <div class={styles.toggleGrid}>
          <ToggleCard
            ...
            onToggle={() =>
              updateSettings({ showRoundNumber: !settings.showRoundNumber })
            }
          ...
          <ToggleCard
            ...
            onToggle={() =>
              updateSettings({ showTotalTime: !settings.showTotalTime })
            }
          ...
          <ToggleCard
            ...
            onToggle={() =>
              updateSettings({
                direction: settings.direction === 'down' ? 'up' : 'down',
              })
            }
        ...
        <div class={styles.settingsCard}>
          <div class={styles.settingRow}>
            ...
            <div class={styles.prepRow}>
              <button
                class={styles.stepBtnSm}
                onClick={() =>
                  updateSettings({
                    countdownSecs: Math.max(0, settings.countdownSecs - 1),
                  })
                }
              >
                −
              ...
              <button
                class={styles.prepValue}
                onClick={() => openNumpad('countdown')}
              >
              ...
              <button
                ...
                onClick={() =>
                  updateSettings({
                    countdownSecs: Math.min(60, settings.countdownSecs + 1),
                  })
                }
              >
                +
